...
class AgenciaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agencium" do
    assert_difference('Agencium.count') do
      post agencia_url, params: { agencium: { codigo: @agencium.codigo, descricao: @agencium.descricao } }
    end
  ...
  test "should update agencium" do
    patch agencium_url(@agencium), params: { agencium: { codigo: @agencium.codigo, descricao: @agencium.descricao } }
